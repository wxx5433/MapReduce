...
public class ReduceTask implements Task {
	...
	// if (!isLocal) {
	// ShuffleConsumerPlugin.Context context = new
	...
	//
	// @SuppressWarnings("unchecked")
	// private <INKEY, INVALUE, OUTKEY, OUTVALUE> void runNewReducer(JobConf
	// job,
	...
	// org.apache.hadoop.mapreduce.TaskAttemptContext taskContext = new
	// org.apache.hadoop.mapreduce.task.TaskAttemptContextImpl(
	// job, getTaskID(), reporter);
	// // make a reducer
	// org.apache.hadoop.mapreduce.Reducer<INKEY, INVALUE, OUTKEY, OUTVALUE>
	// reducer = (org.apache.hadoop.mapreduce.Reducer<INKEY, INVALUE, OUTKEY,
	// OUTVALUE>) ReflectionUtils
	// .newInstance(taskContext.getReducerClass(), job);
	// org.apache.hadoop.mapreduce.RecordWriter<OUTKEY, OUTVALUE> output =
	// (org.apache.hadoop.mapreduce.RecordWriter<OUTKEY, OUTVALUE>) outputFormat
