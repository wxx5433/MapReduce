...
public class RemoteSplitOperator {
	 ...
	 * @param dataNodes The dataNodes to write the file split
	 * @param fileName The file's name which the split belong to 
	 * @param blockIndex The block index for the split 
	 * @param contents The split's contents
	 * @throws Exception
	 */
